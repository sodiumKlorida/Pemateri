...
<body class="bg-gray-100 m-0">
    <div class="container mx-0 sticky top-0">
        <div class="
        header 
        flex 
        items-center   
    ...
    <div class="flex flex-row justify-center mx-6 z-10">
        <div class="flex flex-col ">
            <h3>All</h3>
        </div>
        <div class="flex flex-col ">
        ...
        <?php foreach ($listTugas as $task): ?>
            ...
            <dialog id="modal-<?= $task["id_tugas"] ?>" class="bg-gray-200">
                <div class="bg-white p-8 w-[400px] rounded-lg">
                    <h1>Edit Tugas</h1>
                    <form action="/controller/editAction.php" method="POST" class="flex flex-col">
                        <input type="hidden" name="id" value="<?= $task["id_tugas"] ?>"> <!-- Input tersembunyi untuk ID -->
                        <input class="my-2 outline-gray-900" type="text" name="judul" value="<?= $task["nama_tugas"] ?>">
                        <textarea class="my-2" name="deskripsi"><?= $task["deskripsi_tugas"] ?></textarea>
                        <input type="date" name="date" value="<?= $task['deadline_tugas'] ?>">
